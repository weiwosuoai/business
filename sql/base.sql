...
INSERT INTO t_menu(name, url, parent_id, type, create_time, update_time) VALUES ('系统管理', '/sys/user/manager/list', 0, 1, NOW(), NOW());
INSERT INTO t_menu(name, url, parent_id, type, create_time, update_time) VALUES ('用户管理', '/sys/user/manager/list', 1, 2, NOW(), NOW());
INSERT INTO t_menu(name, url, parent_id, type, create_time, update_time) VALUES ('角色管理', '/sys/role/manager/list', 1, 2, NOW(), NOW());
